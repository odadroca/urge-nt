<div class="p-3">
    ...
    @else
        <form wire:submit="save" class="space-y-2">
            ...
            @error('responseText') <p class="text-red-500 dark:text-red-400 text-xs">{{ $message }}</p> @enderror
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-1">
                    ...
                    <button type="button" wire:click="$set('rating', {{ $i }})"
                            class="p-1 text-base {{ ($rating ?? 0) >= $i ? 'text-amber-500' : 'text-gray-300 dark:text-gray-600' }}"
