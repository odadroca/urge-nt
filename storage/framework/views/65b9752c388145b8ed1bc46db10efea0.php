...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e($title ?? 'URGE'); ?> - URGE</title>
        ...
        <div class="min-h-screen flex flex-col">
            <nav class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 h-14 flex items-center justify-between shrink-0" x-data="{ mobileMenu: false }">
                <div class="flex items-center gap-6">
                    <a href="<?php echo e(route('browse')); ?>" wire:navigate class="flex items-center gap-1.5 text-lg font-bold text-indigo-600 dark:text-indigo-400 tracking-tight">
                        <?php if (isset($component)) { $__componentOriginal8892e718f3d0d7a916180885c6f012e7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8892e718f3d0d7a916180885c6f012e7 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'w-5 h-5 fill-current']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                    ...
                    <div class="hidden sm:flex items-center gap-1">
                        <a href="<?php echo e(route('browse')); ?>" wire:navigate
                           class="px-3 py-1.5 rounded-md text-sm font-medium <?php echo e(request()->routeIs('browse') ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                            Browse
                        </a>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('teams')); ?>" wire:navigate
                           class="px-3 py-1.5 rounded-md text-sm font-medium <?php echo e(request()->routeIs('teams', 'team.detail') ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                            Teams
                        </a>
                        <a href="<?php echo e(route('settings')); ?>" wire:navigate
                           class="px-3 py-1.5 rounded-md text-sm font-medium <?php echo e(request()->routeIs('settings') ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>">
                            Settings
                        </a>
                        ...
                        <a href="<?php echo e($lastPrompt->workspaceUrl()); ?>" wire:navigate
                           ...
                           title="<?php echo e($lastPrompt->name); ?>">
                            Continue: <?php echo e(Str::limit($lastPrompt->name, 20)); ?>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="<?php echo e(route('profile.edit')); ?>" class="hidden sm:inline text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300"><?php echo e(Auth::user()->name); ?></a>
                ...
                <div x-show="mobileMenu" x-cloak @click.outside="mobileMenu = false"
                    ...
                    <a href="<?php echo e(route('browse')); ?>" wire:navigate @click="mobileMenu = false"
                       class="block px-3 py-2 rounded-md text-sm font-medium <?php echo e(request()->routeIs('browse') ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300' : 'text-gray-600 dark:text-gray-400'); ?>">
                        Browse
                    </a>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('teams')); ?>" wire:navigate @click="mobileMenu = false"
                       class="block px-3 py-2 rounded-md text-sm font-medium <?php echo e(request()->routeIs('teams', 'team.detail') ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300' : 'text-gray-600 dark:text-gray-400'); ?>">
                        Teams
                    </a>
                    <a href="<?php echo e(route('settings')); ?>" wire:navigate @click="mobileMenu = false"
                       class="block px-3 py-2 rounded-md text-sm font-medium <?php echo e(request()->routeIs('settings') ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300' : 'text-gray-600 dark:text-gray-400'); ?>">
                        Settings
                    </a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lastPrompt): ?>
                    <a href="<?php echo e($lastPrompt->workspaceUrl()); ?>" wire:navigate @click="mobileMenu = false"
                    ...
                    <div class="pt-2 border-t border-gray-100 dark:border-gray-700 mt-2">
                        <a href="<?php echo e(route('profile.edit')); ?>" @click="mobileMenu = false"
...
<?php /**PATH C:\#DATA\Onedrive\Apps\URGEnt\resources\views/layouts/app.blade.php ENDPATH**/ ?>