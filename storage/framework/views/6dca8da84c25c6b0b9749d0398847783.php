    ...
    <div class="mb-6 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
        <form wire:submit="createTeam" class="flex items-end gap-3">
            <div class="flex-1">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['newTeamName'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($teams->count() > 0): ?>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <a href="<?php echo e(route('team.detail', $team)); ?>" wire:navigate
           class="block bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 hover:border-indigo-300 dark:hover:border-indigo-600 hover:shadow-sm transition">
            <div class="flex items-center justify-between mb-2">
                <h3 class="font-medium text-gray-900 dark:text-gray-100 truncate"><?php echo e($team->name); ?></h3>
                <span class="text-[10px] px-1.5 py-0.5 rounded-full font-medium
                    <?php echo e($team->pivot->role === 'owner'
                        ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400'
                        : 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400'); ?>">
                    <?php echo e($team->pivot->role); ?>
            ...
            <div class="flex items-center gap-3 text-xs text-gray-500 dark:text-gray-400">
                <span class="flex items-center gap-1">
                    ...
                    <?php echo e($team->members_count); ?> <?php echo e(Str::plural('member', $team->members_count)); ?>
                ...
                <span class="flex items-center gap-1">
                    ...
                    <?php echo e($team->prompts_count); ?> <?php echo e(Str::plural('prompt', $team->prompts_count)); ?>
...
<?php /**PATH C:\#DATA\Onedrive\Apps\URGEnt\resources\views/livewire/teams.blade.php ENDPATH**/ ?>